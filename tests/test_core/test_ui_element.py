...
class TestUIElement:
    def test_creation(
        ...
        with pytest.raises(
            ValueError,
            match="Need to create at least one UIManager to create UIElements",
        ):
            UIElement(
                relative_rect=pygame.Rect(0, 0, 50, 50),
                manager=None,
    ...
    def test_create_invalid_id(
        ...
        with pytest.raises(
            ValueError, match="Object ID cannot contain fullstops or spaces"
        ):
    ...
    def test_set_container(
        ...
        test_container1 = UIContainer(
            relative_rect=pygame.Rect(100, 100, 300, 300), manager=default_ui_manager
        )
        test_container2 = UIContainer(
            relative_rect=pygame.Rect(100, 100, 300, 300), manager=default_ui_manager
        )
        element = UIElement(
            relative_rect=pygame.Rect(0, 0, 50, 50),
    ...
    def test_update(
        ...
        element.drawable_shape = RectDrawableShape(
            containing_rect=element.rect,
            theming_parameters={
                "normal_bg": pygame.Color("#FFFF00"),
    ...
    def test_set_visual_debug_mode(
        self,
        _init_pygame,
        ...
        default_ui_manager.preload_fonts(
            [{"name": "noto_sans", "point_size": 8, "style": "regular"}]
        )
        element = UIElement(
            relative_rect=pygame.Rect(0, 0, 50, 50),
            manager=default_ui_manager,
    ...
    def test_anchor_targets(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        element_1 = UIElement(
            relative_rect=pygame.Rect(100, 50, 40, 40),
            manager=default_ui_manager,
            container=None,
            starting_height=0,
            layer_thickness=1,
        ...
        element_2 = UIElement(
            relative_rect=pygame.Rect(0, 50, 40, 40),
            manager=default_ui_manager,
            container=None,
            starting_height=0,
            layer_thickness=1,
        ...
        element_4 = UIElement(
            relative_rect=pygame.Rect(50, 100, 40, 40),
            manager=default_ui_manager,
            container=None,
            starting_height=0,
            layer_thickness=1,
        ...
        anchor_element = UIElement(
            relative_rect=pygame.Rect(50, 50, 40, 40),
            manager=default_ui_manager,
            container=None,
            starting_height=0,
            layer_thickness=1,
        ...
        with pytest.warns(
            expected_warning=UserWarning, match=r"Supplied \w+ anchors are invalid"
        ):
            anchor_element = UIElement(
                relative_rect=pygame.Rect(50, 50, 40, 40),
                manager=default_ui_manager,
        ...
        UIElement(
            ...
            starting_height=0,
            layer_thickness=1,
            anchors={"centerx": "centerx", "centerx_target": element_1},
        )
        ...
        UIElement(
            ...
            starting_height=0,
            layer_thickness=1,
            anchors={"centery": "centery", "centery_target": element_2},
        )
