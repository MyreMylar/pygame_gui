...
class TestWindowStack:
    ...
    def test_add_window_always_on_top(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        stack = UIWindowStack((800, 600), default_ui_manager.get_root_container())
        window = UIWindow(
    ...
    def test_clear_with_always_on_top(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        stack = UIWindowStack((800, 600), default_ui_manager.get_root_container())
        window = UIWindow(
    ...
    def test_remove_window_with_always_on_top(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        stack = UIWindowStack((800, 600), default_ui_manager.get_root_container())
        window_always_on_top = UIWindow(
        ...
        window_always_on_top_2 = UIWindow(
            pygame.Rect(0, 0, 200, 200),
            window_display_title="Test Window",
            manager=default_ui_manager,
            element_id="test_window",
    ...
    def test_move_window_to_front_with_always_on_top(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        stack = UIWindowStack((800, 600), default_ui_manager.get_root_container())
        window_always_on_top = UIWindow(
    ...
    def test_swap_window_always_on_top(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
    ...
    def test_update_always_on_top(
        ...
        UIDropDownMenu(
            ...
            "Test",
            (50, 50, 120, 30),
            container=window_always_on_top,
            manager=manager,
        )
