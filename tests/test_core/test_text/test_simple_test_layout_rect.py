...
class TestSimpleTestLayoutRect:
    ...
    def test_finalise(
        ...
        simple_rect.finalise(
            target_surface=rendered_chunk_surf,
    ...
    def test_split(
        ...
        simple_rect = SimpleTestLayoutRect(
            dimensions=(200, 30), create_split_points=False
        )
    ...
    @pytest.mark.parametrize(
        "requested_x, line_width, row_start_x, split_points, expected_width",
        [
            # Happy path tests
    ...
    def test_split_various_cases(
        self, requested_x, line_width, row_start_x, split_points, expected_width
    ):
        # Arrange
        rect = SimpleTestLayoutRect(dimensions=(100, 20), create_split_points=True)
