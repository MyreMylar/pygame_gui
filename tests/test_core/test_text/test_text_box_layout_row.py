...
class TestTextBoxLayoutRow:
    ...
    def test_horiz_center_row(
        ...
        simple_rect = SimpleTestLayoutRect(
            dimensions=(20, 30), float_pos=TextFloatPosition.LEFT
        )
        simple_rect_2 = SimpleTestLayoutRect(
    ...
    def test_align_left_row(
        ...
        layout_row.horiz_center_row(text_box_layout.floating_rects)
        layout_row.align_left_row(
            floating_rects=text_box_layout.floating_rects, start_x=5
        )
    ...
    def test_vert_align_items_to_row(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        input_data = deque([])
        line_spacing = 1.25
        ...
        text_chunk_1 = TextLineChunkFTFont(
            text="hello ",
            font=font_1,
            underlined=False,
        ...
        text_chunk_2 = TextLineChunkFTFont(
            text="this is a",
            font=font_2,
            underlined=False,
            colour=pygame.Color("#FFFFFF"),
        ...
        text_chunk_3 = TextLineChunkFTFont(
            text=" test",
            font=font_3,
            underlined=False,
            colour=pygame.Color("#FFFFFF"),
    ...
    def test_merge_adjacent_compatible_chunks(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        input_data = deque([])
        line_spacing = 1.25
    ...
    def test_insert_text(
        ...
        combined_ids = default_ui_manager.get_theme().build_all_combined_ids(
            [None], ["text_box"], ["@test_text"], ["#test_text_1"]
        )
        link_style = {
            "link_text": pygame.Color("#80A0F0"),
        ...
        parser = HTMLParser(
            ui_theme=default_ui_manager.get_theme(),
        ...
        with pytest.raises(
            AttributeError, match="Trying to insert into empty text row with no Parser"
        ):
