...
class TestTextLineChunkFTFont:
    ...
    def test_finalise(
        ...
        chunk_2 = TextLineChunkFTFont(
            ...
            font=the_font,
            underlined=False,
            colour=ColourGradient(0, pygame.Color("#FFFF00"), pygame.Color("#FF0000")),
            using_default_text_colour=False,
            bg_colour=pygame.Color("#FF0000"),
        )
        ...
        chunk_3 = TextLineChunkFTFont(
            ...
            bg_colour=ColourGradient(
                0, pygame.Color("#FFFF00"), pygame.Color("#FF0000")
            ),
        )
    ...
    def test_delete_letter_at_index(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 30)
    ...
    def test_backspace_letter_at_index(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 30)
