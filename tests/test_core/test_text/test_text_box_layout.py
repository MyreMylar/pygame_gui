...
class TestTextBoxLayout:
    def test_creation(
        ...
        input_data = deque([])
        default_font = (
            default_ui_manager.get_theme().get_font_dictionary().get_default_font()
        )
        default_font_data = {
            "font": default_font,
    ...
    def test_creation_with_data(
        ...
        input_data = deque(
            [
                ...
                SimpleTestLayoutRect(dimensions=(175, 20)),
                HorizRuleLayoutRect(
                    height=1, colour_or_gradient=pygame.Color(255, 255, 255)
                ),
                SimpleTestLayoutRect(dimensions=(110, 20)),
                SimpleTestLayoutRect(
                    dimensions=(100, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(20, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(20, 30), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(22, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(32, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(32, 20), float_pos=TextFloatPosition.LEFT
                ),
                ...
                SimpleTestLayoutRect(dimensions=(30, 20)),
                SimpleTestLayoutRect(
                    dimensions=(100, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(20, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(20, 30), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(33, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(32, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(22, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(dimensions=(30, 20)),
                SimpleTestLayoutRect(dimensions=(30, 20)),
                SimpleTestLayoutRect(dimensions=(30, 20)),
        ...
        input_data = deque(
            [
                SimpleTestLayoutRect(
                    dimensions=(25, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(25, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(25, 30), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(21, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(22, 20), float_pos=TextFloatPosition.LEFT
                ),
                SimpleTestLayoutRect(
                    dimensions=(23, 20), float_pos=TextFloatPosition.LEFT
                ),
            ]
        )
        ...
        input_data = deque(
            [
                SimpleTestLayoutRect(
                    dimensions=(25, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(25, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(25, 30), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(21, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(22, 20), float_pos=TextFloatPosition.RIGHT
                ),
                SimpleTestLayoutRect(
                    dimensions=(23, 20), float_pos=TextFloatPosition.RIGHT
                ),
            ]
        )
        ...
        input_data = deque(
            [
                ImageLayoutRect(
                    image_path="tests/data/images/test_emoji.png",
    ...
    def test_too_wide_image(
        ...
        input_data = deque(
            [
                ...
                SimpleTestLayoutRect(dimensions=(30, 20)),
                ImageLayoutRect(
                    image_path="tests/data/images/space_1.jpg",
                    float_position=TextFloatPosition.RIGHT,
                    padding=Padding(0, 0, 0, 0),
                ),
            ]
    ...
    def test_reprocess_layout_queue(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        input_data = deque(
            [
    ...
    def test_update_text_with_new_text_end_pos(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        default_font = (
            default_ui_manager.get_theme().get_font_dictionary().get_default_font()
        ...
        layout_surface = layout.finalise_to_new()
        layout.update_text_with_new_text_end_pos(
            0
        )  # this does nothing unless we pass in text
    ...
    def test_add_chunks_to_hover_group(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        input_data = deque(
            [
    ...
    def test_insert_layout_rects(
        ...
        layout.insert_layout_rects(
            layout_rects=insert_data, row_index=0, item_index=1, chunk_index=9
        )
        ...
        layout.insert_layout_rects(
            layout_rects=insert_data, row_index=0, item_index=0, chunk_index=50
        )  # deliberately high, our find function should clamp this
        ...
        insert_data = deque(
            [
                TextLineChunkFTFont(
                    text=" and then even more text, text forever. loads of text."
        ...
        layout.insert_layout_rects(
            layout_rects=insert_data, row_index=0, item_index=0, chunk_index=46
        )

    def test_horiz_centre_all_rows(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
    ...
    def test_vert_align_top_all_rows(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
    ...
    def test_vert_align_bottom_all_rows(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
    ...
    def test_set_cursor_from_click_pos(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
    ...
    def test_set_default_text_colour(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
    ...
    def test_insert_text(
        ...
        layout.insert_text(
            "text on the end", 51
        )  # deliberately high number that should get clamped
    ...
    def test_delete_selected_text(
        ...
        layout.insert_layout_rects(
            layout_rects=insert_data, row_index=0, item_index=0, chunk_index=8
        )

        layout.set_text_selection(62, 112)
        layout.delete_selected_text()

    def test_delete_at_cursor(
        self, _init_pygame, _display_surface_return_none, default_ui_manager: UIManager
    ):
        the_font = GUIFontFreetype(None, 20)
        input_data = deque(
