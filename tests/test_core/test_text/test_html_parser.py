...
class TestHTMLParser:
    ...
    def test_handle_start_tag(
        ...
        assert parser.current_style["shadow_data"][
            3
        ] == default_ui_manager.get_theme().get_colour_or_gradient(
            "link_text", combined_ids
        )
        ...
        parser.handle_starttag(
            tag="img",
            attrs=[
                ("src", "tests/data/images/splat.png"),
                ("float", "none"),
                ("padding", "0 0 0"),
            ],
        )
