...
class TestUIUIFileDialog:
    def test_creation(
        ...
        UIFileDialog(rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager)

        UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
    ...
    def test_create_too_small(
        ...
        with pytest.warns(UserWarning, match="Initial size"):
            UIFileDialog(rect=pygame.Rect(100, 100, 50, 50), manager=default_ui_manager)
    ...
    def test_create_options(
        ...
        UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
            manager=default_ui_manager,
            initial_file_path="tests/data/images/splat.png",
        )

        UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
            manager=default_ui_manager,
            initial_file_path="tests/data/images/splot.png",
        )

        UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
            manager=default_ui_manager,
            initial_file_path="nonsense/path/that/does/not/exist",
        )
    ...
    def test_update_current_file_list(
        ...
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager
        )
    ...
    def test_press_ok_button(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=(100, 100, 440, 500), manager=default_ui_manager
        )
        ...
        for event in pygame.event.get():
            ...
            if (
                event.type == pygame_gui.UI_FILE_DIALOG_PATH_PICKED
    ...
    def test_press_delete_button_and_cancel(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager
        ...
        confirm_delete_event = pygame.event.Event(
    ...
    def test_press_delete_button_and_ok(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager
    ...
    def test_press_parent_button(
        ...
        parent_event = pygame.event.Event(
    ...
    def test_press_refresh_button(
        ...
        parent_event = pygame.event.Event(
            pygame_gui.UI_BUTTON_PRESSED, {"ui_element": file_dialog.refresh_button}
        )
    ...
    def test_press_home_button(
        ...
        home_event = pygame.event.Event(
            pygame_gui.UI_BUTTON_PRESSED, {"ui_element": file_dialog.home_button}
        )
    ...
    def test_new_file_selection(
        ...
        select_event = pygame.event.Event(
            ...
            {"ui_element": file_dialog.file_selection_list, "text": "splat.png"},
        )
        ...
        select_event = pygame.event.Event(
            pygame_gui.UI_SELECTION_LIST_NEW_SELECTION,
            {"ui_element": file_dialog.file_selection_list, "text": "images"},
        )
        ...
        select_event = pygame.event.Event(
            pygame_gui.UI_SELECTION_LIST_NEW_SELECTION,
            {"ui_element": file_dialog.file_selection_list, "text": "not_a_file.not"},
        )
    ...
    def test_directory_double_clicked(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
        ...
        event_data = {"ui_element": file_dialog.file_selection_list, "text": "images"}
        directory_event = pygame.event.Event(
            pygame_gui.UI_SELECTION_LIST_DOUBLE_CLICKED_SELECTION, event_data
        )

        default_ui_manager.process_events(directory_event)

        assert file_dialog.current_directory_path == str(
            Path("tests/data/images").resolve()
        )
        assert not file_dialog.ok_button.is_enabled
        assert not file_dialog.delete_button.is_enabled
        assert file_dialog.file_path_text_line.text == str(
            Path("tests/data/images").resolve()
        )

    def test_file_path_entry_finished(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager
    ...
    def test_process_event(self, default_ui_manager, _display_surface_return_none):
        ...
        file_dialog.process_event(
            pygame.event.Event(
                UI_TEXT_ENTRY_CHANGED, {"ui_element": file_dialog.file_path_text_line}
            )
        )
        ...
        file_dialog.process_event(
            pygame.event.Event(
                UI_TEXT_ENTRY_FINISHED, {"ui_element": file_dialog.file_path_text_line}
            )
        )
    ...
    def test_show(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=default_ui_manager, visible=0
        )
        file_dialog.file_path_text_line.set_text("tests/data/images")
    ...
    def test_show_hide_rendering(
        ...
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500), manager=manager, visible=0
        )
        file_dialog.file_path_text_line.set_text("tests/data/images")
        manager.update(0.01)
    ...
    def test_change_directory_path(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
    ...
    def test_highlight_file_name_for_editing(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        file_dialog = UIFileDialog(
            rect=pygame.Rect(100, 100, 440, 500),
