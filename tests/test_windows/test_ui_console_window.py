...
class TestUIConsoleWindow:
    def test_creation(self, _init_pygame, default_ui_manager):
        ...
        UIConsoleWindow(
            rect=pygame.rect.Rect((0, 0), (700, 500)), manager=default_ui_manager
        )

    def test_command_entry_finished(self, _init_pygame, default_ui_manager):
        pygame.display.set_mode((800, 600))
        console_window = UIConsoleWindow(
            rect=pygame.rect.Rect((0, 0), (300, 200)), manager=default_ui_manager
        )
        ...
        logged_line = (
            console_window.log_prefix + "&lt;b&gt;A line of text to log&lt;/b&gt;<br>"
        )
        ...
        logged_lines = (
            console_window.log_prefix
            + "&lt;b&gt;A line of text to log&lt;/b&gt;<br>"
            + console_window.log_prefix
            + "<b>A second line of text to log</b><br>"
        )
        ...
        # add a lot of text
        console_window.command_entry.set_text(
            "More text to fill up the log, blah, blah, blah, blah. "
    ...
    def test_add_output_line_to_log(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        console_window = UIConsoleWindow(
            rect=pygame.rect.Rect((0, 0), (700, 500)), manager=default_ui_manager
        ...
        console_window.add_output_line_to_log(
            "second line to add, no line break", is_bold=False, remove_line_break=True
        )

        assert console_window.log.appended_text == (
            "<b>line to add</b><br>" "second line to add, no line break"
        )

        console_window.add_output_line_to_log(
            "third <i>line</i> to add, escape html", escape_html=True
        )
    ...
    def test_scroll_log_with_arrow_keys(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        console_window = UIConsoleWindow(
            rect=pygame.rect.Rect((0, 0), (700, 500)), manager=default_ui_manager
