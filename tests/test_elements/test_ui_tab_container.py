...
class TestUITabContainer:
    ...
    def test_creation(self, _init_pygame, _display_surface_return_none, default_ui_manager):
        UITabContainer(relative_rect=pygame.Rect(50, 50, 150, 400),
                       manager=default_ui_manager)

    def test_creation_with_tab(self, _init_pygame, _display_surface_return_none, default_ui_manager):
        tab_container = UITabContainer(relative_rect=pygame.Rect(50, 50, 150, 400),
                                       manager=default_ui_manager)
    ...
    def test_add_button(self, _init_pygame, _display_surface_return_none, default_ui_manager):
        ...
        tab_1_container = tab_container.get_tab_container(tab_container.add_tab("Tab 1", "tab_1"))
    ...
    def test_set_dimensions(self, _init_pygame, _display_surface_return_none, default_ui_manager):
        test_container = UIContainer(relative_rect=pygame.Rect(10, 10, 700, 500),
                                     manager=default_ui_manager)

        tab_container_1 = UITabContainer(relative_rect=pygame.Rect(50, 50, 150, 350),
                                         manager=default_ui_manager,
    ...
    def test_get_title_text(self, _init_pygame: None, default_ui_manager: UIManager,
                            _display_surface_return_none: None):
        tab_container = UITabContainer(relative_rect=pygame.Rect(50, 50, 150, 400),
                                       manager=default_ui_manager)
        tab_1_id = tab_container.add_tab("Tab 1", "tab_1")
