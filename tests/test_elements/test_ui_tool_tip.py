...
class TestUIToolTip:
    ...
    def test_find_invalid_position(
        self, _init_pygame, default_ui_manager: UIManager, _display_surface_return_none
    ):
        tool_tip = UITooltip(
            html_text="A tip about tools.",
    ...
    def test_find_valid_position_off_bottom(
        self, _init_pygame, default_ui_manager: UIManager, _display_surface_return_none
    ):
        tool_tip = UITooltip(
            html_text="A tip about tools.",
        ...
        assert (
            found_position is True
            and bool(root_window_rect.contains(tool_tip.rect)) is True
        )

    def test_find_valid_position_off_right(
        self, _init_pygame, default_ui_manager: UIManager, _display_surface_return_none
    ):
        tool_tip = UITooltip(
            html_text="A tip about tools.",
    ...
    def test_find_valid_position_off_left(
        self, _init_pygame, default_ui_manager: UIManager, _display_surface_return_none
    ):
        tool_tip = UITooltip(
            html_text="A tip about tools.",
    ...
    def test_find_valid_position_screen_too_small(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager((50, 50))
        tool_tip = UITooltip(
            html_text="A tip about tools.", hover_distance=(0, 10), manager=manager
        )
        ...
        assert (
            found_position is False
            and bool(root_window_rect.contains(tool_tip.rect)) is False
        )

    def test_non_default_theme_build(self, _init_pygame, _display_surface_return_none):
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_tool_tip_non_default.json"),
        )
        tool_tip = UITooltip(
            html_text="A tip about tools.", hover_distance=(0, 10), manager=manager
        )
    ...
    def test_bad_values_theme_build(self, _init_pygame, _display_surface_return_none):
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_tool_tip_bad_values.json"),
        )
        tool_tip = UITooltip(
            html_text="A tip about tools.", hover_distance=(0, 10), manager=manager
        )
    ...
    def test_set_position(
        ...
        assert tool_tip.rect.topleft == (
            150,
            30,
        ) and tool_tip.text_block.rect.topleft == (150, 30)
    ...
    def test_set_dimensions(
        ...
        assert tool_tip.rect.bottomright == (
            100,
            150,
        ) and tool_tip.text_block.rect.bottomright == (100, 150)
