...
class TestUIAutoScrollingContainer:

    def test_creation(self, _init_pygame, default_ui_manager,
                      _display_surface_return_none):
        UIAutoScrollingContainer(relative_rect=pygame.Rect(100, 100, 400, 400),
    ...
    def test_set_relative_position(self, _init_pygame, default_ui_manager,
        ...
        container = UIAutoScrollingContainer(pygame.Rect(100, 100, 200, 200),
                                             manager=default_ui_manager)
        container_2 = UIAutoScrollingContainer(pygame.Rect(50, 50, 50, 50),
                                               manager=default_ui_manager,
                                               container=container)
    ...
    def test_show(self, _init_pygame, default_ui_manager,
                  _display_surface_return_none):
        container = UIAutoScrollingContainer(relative_rect=pygame.Rect(100, 100, 400, 400),
    ...
    def test_show_hide_rendering(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        container = UIAutoScrollingContainer(relative_rect=pygame.Rect(100, 100, 200, 100),
                                             manager=manager,
                                             visible=0)
