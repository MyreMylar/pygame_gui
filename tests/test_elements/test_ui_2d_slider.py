...
class TestUI2DSlider:
    ...
    def test_check_has_moved_recently(
        ...
        pygame.mouse.set_pos(
            (
                slider.sliding_button.get_abs_rect().centerx + 20,
    ...
    def test_check_update_sliding_bar(
        ...
        non_y_invert_slider = UI2DSlider(
            relative_rect=pygame.Rect(0, 0, 200, 30),
            start_value_x=50,
            value_range_x=(0, 100),
            start_value_y=50,
    ...
    def test_set_position(
        ...
        slider = UI2DSlider(
            relative_rect=pygame.Rect(300, 400, 200, 200),
            start_value_x=100,
            value_range_x=(0, 200),
            start_value_y=100,
            value_range_y=(0, 200),
        ...
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (305, 305)})
        )
    ...
    def test_set_relative_position(
        ...
        slider = UI2DSlider(
            relative_rect=pygame.Rect(300, 400, 150, 150),
            start_value_x=75,
            value_range_x=(0, 150),
            start_value_y=75,
            value_range_y=(0, 150),
        ...
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (330, 330)})
        )
    ...
    def test_set_dimensions(
        ...
        # try to click on the slider
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (105, 105)})
        )
        # if we successfully clicked on the moved slider then this button should be True
        assert slider.sliding_button.held is True
        ...
        # try to click on the slider
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (55, 55)})
        )
        # if we successfully clicked on the moved slider then this button should be True
        assert slider.sliding_button.held is True
    ...
    def test_disable(
        ...
        slider.sliding_button.process_event(
            pygame.event.Event(
                ...
                {"button": 1, "pos": slider.sliding_button.rect.center},
            )
        )
        slider.update(0.1)
    ...
    def test_show_hide_rendering(
        ...
        slider = UI2DSlider(
            relative_rect=pygame.Rect(25, 25, 375, 375),
            start_value_x=50,
            value_range_x=(0, 200),
            start_value_y=50,
            value_range_y=(0, 200),
