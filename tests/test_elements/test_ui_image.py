...
class TestUIImage:
    ...
    def test_set_dimensions(
        ...
        assert ui_image.image.get_size() == (150, 30) and ui_image.rect.size == (
            150,
            30,
        )
        ...
        assert ui_image.image.get_size() == (200, 200) and ui_image.rect.size == (
            200,
            200,
        )
        ...
        ui_image = UIImage(
            relative_rect=pygame.Rect(10, 10, 128, 128),
            image_surface=loaded_image,
            manager=default_ui_manager,
            container=container,
        )
        ...
        assert ui_image.image.get_size() == (128, 128) and ui_image.rect.size == (
            128,
            128,
        )
