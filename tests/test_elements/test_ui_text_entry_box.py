...
class TestUITextEntryBox:
    ...
    def test_creation_grow_to_fit_width(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_creation_and_rebuild_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
        ...
        default_ui_manager.preload_fonts(
            [
                {"name": "noto_sans", "html_size": 4.5, "style": "bold"},
    ...
    def test_create_too_narrow_textbox_for_font(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
        ...
        with pytest.raises(RuntimeError, match="Row longer than layout"):
            text_box = UITextEntryBox(
                initial_text="la la LA LA LAL LAL ALALA"
    ...
    def test_set_position_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
        ...
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (92, 8)})
        )
    ...
    def test_set_relative_position_with_scrollbar(
        ...
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (142, 8)})
        )
        # if we successfully clicked on the moved text box
        # scroll bar then this button should be True
        assert text_box.scroll_bar.top_button.held is True

    def test_update_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_update_without_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        ...
        text_box = UITextEntryBox(
            initial_text="<a href=None>lalaLAlalala</a>",
    ...
    def test_redraw_from_text_block_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_redraw_from_chunks_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_full_redraw_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_select_with_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_set_active_effect_fade_in(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_box.update(5.0)
        assert isinstance(
            text_box.active_text_effect, pygame_gui.core.text.FadeInEffect
        )

    def test_set_active_effect_fade_out(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_box.update(5.0)
        assert isinstance(
            text_box.active_text_effect, pygame_gui.core.text.FadeOutEffect
        )

    def test_set_active_effect_invalid(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_set_active_effect_none(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none,
    ...
    def test_set_active_effect_with_word_split(
        self, _init_pygame: None, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
        ...
        htm_text_block_2 = UITextEntryBox(
            initial_text="<font face=noto_sans size=2 color=#000000>"
        ...
        htm_text_block_2.update(5.0)
        assert isinstance(
            htm_text_block_2.active_text_effect, pygame_gui.core.text.TypingAppearEffect
        )
    ...
    def test_process_event_mouse_buttons_with_scrollbar(
        ...
        processed_down_event = text_box.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (30, 15)})
        )
        text_box.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONUP, {"button": 1, "pos": (80, 15)})
        )

        assert processed_down_event is True

    def test_process_event_mouse_buttons_no_scrollbar(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_box = UITextEntryBox(
            initial_text="<a href=none>alalaadads<a/>",
            relative_rect=pygame.Rect(0, 0, 150, 100),
            manager=default_ui_manager,
        )

        processed_down_event = text_box.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (20, 15)})
        )
        text_box.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONUP, {"button": 1, "pos": (20, 15)})
        )
    ...
    def test_rebuild_from_theme_data_non_default(
        ...
        text_box = UITextEntryBox(
            initial_text="<font color=#FF0000 face=noto_sans>Some "
    ...
    def test_rebuild_from_theme_data_bad_values(
        ...
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_text_box_bad_values.json"),
        )
    ...
    def test_set_dimensions(
        ...
        default_ui_manager.process_events(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (195, 75)})
        )
    ...
    def test_disable(
        ...
        text_entry = UITextEntryBox(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_d, "mod": 0, "unicode": "d"}
            )
        )
    ...
    def test_enable(
        ...
        text_entry.focus()
        # process a mouse button down event
        processed_text_input_event = text_entry.process_event(
            pygame.event.Event(pygame.TEXTINPUT, {"text": "d"})
        )
    ...
    def test_rebuild_select_area_1(
        self, _init_pygame, default_ui_manager, _display_surface_return_none
    ):
        text_entry = UITextEntryBox(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
    ...
    def test_set_text_rebuild_select_area_2(
        ...
        manager = UIManager(
            (800, 600),
            os.path.join(
                "tests", "data", "themes", "ui_text_entry_line_non_default.json"
            ),
        )

        text_entry = UITextEntryBox(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=manager
        )
    ...
    def test_set_text_rebuild_select_area_3(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
            os.path.join(
                "tests", "data", "themes", "ui_text_entry_line_non_default_2.json"
            ),
        )
    ...
    @pytest.mark.filterwarnings("ignore:Image data validation")
    @pytest.mark.filterwarnings("ignore:Invalid border_width value")
    def test_set_text_rebuild_select_area_4(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
            os.path.join(
                "tests", "data", "themes", "ui_text_entry_line_bad_values.json"
            ),
        )
    ...
    def test_process_event_text_entered_with_select_range(
        ...
        processed_text_input_event = text_entry.process_event(
            pygame.event.Event(pygame.TEXTINPUT, {"text": "o"})
        )

        assert (
            processed_text_input_event is True
            and text_entry.get_text() == "Ho hours of fun writing tests"
        )

    def test_process_event_text_ctrl_v(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_c, "mod": pygame.KMOD_CTRL, "unicode": "c"},
            )
        )
    ...
    def test_process_event_ctrl_v_at_limit(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_ctrl_a(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_a, "mod": pygame.KMOD_CTRL, "unicode": "a"},
            )
        )
    ...
    def test_process_event_text_ctrl_x(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_x, "mod": pygame.KMOD_CTRL, "unicode": "x"},
            )
        )
    ...
    def test_process_event_mouse_buttons(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_entry = UITextEntryBox(
            relative_rect=pygame.Rect(0, 0, 200, 30), manager=default_ui_manager
        )

        text_entry.set_text("dan is amazing")
        processed_down_event = text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (32, 15)})
        )
    ...
    def test_process_event_mouse_button_double_click(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        text_entry.set_text("dan is amazing")
        processed_down_event = text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (90, 15)})
        )
        processed_up_event = text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (90, 15)})
        )
        ...
        assert (
            processed_down_event
            and processed_up_event
            and text_entry.select_range == [7, 14]
        )
        ...
        assert (
            processed_down_event
            and processed_up_event
            and text_entry.select_range == [0, 0]
        )
    ...
    def test_process_event_mouse_button_double_click_first_word(
        ...
        processed_down_event = text_entry.process_event(
            pygame.event.Event(
                pygame.MOUSEBUTTONDOWN, {"button": pygame.BUTTON_LEFT, "pos": (15, 15)}
            )
        )
        processed_up_event = text_entry.process_event(
            pygame.event.Event(
    ...
    def test_process_event_mouse_button_up_outside(
        ...
        text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONUP, {"button": 1, "pos": (80, 50)})
        )

        assert processed_down_event and text_entry.selection_in_progress is False

    def test_process_event_text_return(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_right(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_right_actually_move(
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_RIGHT, "mod": pygame.KMOD_SHIFT}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_LEFT, "mod": pygame.KMOD_SHIFT}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_RIGHT, "mod": pygame.KMOD_CTRL}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_RIGHT, "mod": pygame.KMOD_CTRL | pygame.KMOD_SHIFT},
            )
        )
    ...
    def test_process_event_text_left(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_LEFT, "mod": pygame.KMOD_CTRL | pygame.KMOD_SHIFT},
            )
        )
    ...
    def test_process_event_text_down(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_DOWN, "mod": pygame.KMOD_SHIFT}
            )
        )
    ...
    def test_process_event_text_up(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_UP, "mod": pygame.KMOD_SHIFT}
            )
        )
    ...
    def test_process_event_home(
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(pygame.KEYDOWN, {"key": pygame.K_HOME, "mod": 0})
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_HOME, "mod": pygame.KMOD_CTRL}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_HOME, "mod": pygame.KMOD_SHIFT}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_HOME, "mod": pygame.KMOD_SHIFT | pygame.KMOD_CTRL},
            )
        )
    ...
    def test_process_event_end(
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(pygame.KEYDOWN, {"key": pygame.K_END, "mod": 0})
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_END, "mod": pygame.KMOD_CTRL}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_END, "mod": pygame.KMOD_SHIFT}
            )
        )
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN,
                {"key": pygame.K_END, "mod": pygame.KMOD_SHIFT | pygame.KMOD_CTRL},
            )
        )
    ...
    def test_process_event_text_right_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_left_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_up_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_down_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_delete_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_redraw_selected_text_different_theme(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
    ...
    def test_update_after_click(
        self, _init_pygame, _display_surface_return_none: None, default_ui_manager
    ):
        manager = UIManager(
            (800, 600),
            os.path.join(
        ...
        text_entry = UITextEntryBox(
            relative_rect=pygame.Rect(0, 0, 200, 30), manager=manager
        )
    ...
    def test_update_newline_after_click(
        self, _init_pygame, _display_surface_return_none: None, default_ui_manager
    ):
        manager = UIManager(
            (800, 600),
    ...
    @pytest.mark.filterwarnings("ignore:Image data validation")
    @pytest.mark.filterwarnings("ignore:Invalid border_width value")
    def test_rebuild_from_theme_data_bad_values_again(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
    ...
    def test_set_position(
        ...
        assert text_entry.relative_rect.topleft == (
            50,
            -70,
        ) and text_entry.drawable_shape.containing_rect.topleft == (150, 30)
