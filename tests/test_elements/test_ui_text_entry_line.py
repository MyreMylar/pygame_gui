...
class TestUITextEntryLine:
    ...
    def test_set_text_length_limit(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
        ...
        with pytest.warns(
            UserWarning,
            match="Tried to set text string that" " is too long on text entry element",
        ):
    ...
    def test_set_text_forbidden_characters(
        self,
        _init_pygame,
    ...
    def test_process_event_text_entered_forbidden(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_text_entered_not_allowed(
        ...
        processed_key_event = text_entry.process_event(
            pygame.event.Event(
                pygame.KEYDOWN, {"key": pygame.K_o, "mod": 0, "unicode": "o"}
            )
        )
    ...
    def test_process_event_text_entered_too_long(
        ...
        processed_text_input_event = text_entry.process_event(
            pygame.event.Event(pygame.TEXTINPUT, {"text": "t"})
        )

        assert processed_text_input_event is False and text_entry.get_text() == "tes"

    def test_process_event_text_ctrl_c(
        self, _init_pygame: None, _display_surface_return_none: None
    ):
        manager = UIManager(
            (800, 600),
            os.path.join(
    ...
    def test_process_event_ctrl_v_over_limit(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_ctrl_v_over_limit_select_range(
        self,
        _init_pygame: None,
        default_ui_manager: UIManager,
        _display_surface_return_none: None,
    ...
    def test_process_event_mouse_button_double_click_in_empty_space(
        ...
        text_entry.set_text("                      dan")
        processed_down_event = text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (50, 15)})
        )
        processed_up_event = text_entry.process_event(
            pygame.event.Event(pygame.MOUSEBUTTONDOWN, {"button": 1, "pos": (50, 15)})
        )
    ...
    def test_set_allowed_characters_predefined(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
    ...
    def test_set_allowed_characters_anything(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
    ...
    def test_set_allowed_characters_invalid_id(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
        ...
        with pytest.warns(
            UserWarning,
            match="Trying to set allowed characters by " "type string, but no match",
        ):
            text_entry.set_allowed_characters("dan")

    def test_set_forbidden_characters_predefined(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
    ...
    def test_set_forbidden_characters_anything(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
    ...
    def test_set_forbidden_characters_invalid_id(
        self, _init_pygame, _display_surface_return_none, default_ui_manager
    ):
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 200, 30), manager=default_ui_manager
        ...
        with pytest.warns(
            UserWarning,
            match="Trying to set forbidden characters by type " "string, but no match",
        ):
    ...
    def test_redraw_selected_text_different_them(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
    ...
    def test_show_hide_rendering(
        ...
        text_entry = UITextEntryLine(
            relative_rect=pygame.Rect(100, 100, 400, 400), manager=manager, visible=0
        )
        manager.update(0.01)
