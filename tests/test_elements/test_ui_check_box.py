...
class TestUICheckBox:
    def test_creation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
    ...
    def test_creation_with_initial_state(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
                              initial_state=True)
    ...
    def test_creation_with_container(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        container = UIContainer(relative_rect=pygame.Rect(50, 50, 200, 200),
                               manager=default_ui_manager)
        check_box = UICheckBox(relative_rect=pygame.Rect(10, 10, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
                              container=container)
    ...
    def test_creation_with_anchors(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        container = UIContainer(relative_rect=pygame.Rect(50, 50, 200, 200),
                               manager=default_ui_manager)
        check_box = UICheckBox(relative_rect=pygame.Rect(-20, -20, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
                              container=container,
                              anchors={'left': 'right',
    ...
    def test_get_set_state(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_process_event_left_click(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
        
        # Click the checkbox
        consumed = check_box.process_event(pygame.event.Event(pygame.MOUSEBUTTONDOWN,
                                                             {'button': pygame.BUTTON_LEFT,
                                                              'pos': check_box.rect.center}))
        
        assert consumed is True
        assert check_box.get_state() is True

    def test_process_event_right_click_ignored(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_process_event_outside_click_ignored(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_process_event_disabled_ignored(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_process_event_toggle_multiple_times(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
        ...
        for i in range(5):
            check_box.process_event(pygame.event.Event(pygame.MOUSEBUTTONDOWN,
                                                      {'button': pygame.BUTTON_LEFT,
                                                       'pos': check_box.rect.center}))
            expected_state = (i + 1) % 2 == 1
            assert check_box.get_state() is expected_state

    def test_process_event_generates_ui_event(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_enable_disable_state_preservation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
                              initial_state=True)
    ...
    def test_show_hide(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
                              visible=0)
    ...
    def test_show_hide_rendering(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        check_box = UICheckBox(relative_rect=pygame.Rect(25, 25, 20, 20),
                              text="Test Check Box",
                              manager=manager,
                              visible=0)
    ...
    def test_set_text(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_set_text_empty(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_set_text_unicode(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_set_relative_position(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        assert check_box.rect.topleft == (80, 90)  # container offset + relative position

    def test_check_hover(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_hover_point(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_on_hovered_unhovered(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_drawable_shape_states(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_object_id(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager,
    ...
    def test_object_id_none(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_class_theming_id(self, _init_pygame, _display_surface_return_none):
        ...
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=manager,
                              object_id=ObjectID(object_id='#test_object_1',
                                               class_id='@test_class'))
    ...
    def test_text_label_positioning(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_text_label_anchoring(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_focus_methods(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_can_hover(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_while_hovering(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_get_focus_set(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                              text="Test Check Box",
                              manager=default_ui_manager)
    ...
    def test_edge_case_very_small_size(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        # Test with very small size
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 1, 1),
                              text="Test",
                              manager=default_ui_manager)
        assert check_box.image is not None
        assert check_box.rect.size == (1, 1)

    def test_edge_case_large_size(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        # Test with large size
        check_box = UICheckBox(relative_rect=pygame.Rect(100, 100, 200, 200),
                              text="Test",
                              manager=default_ui_manager)
        assert check_box.image is not None
        assert check_box.rect.size == (200, 200)

    def test_multiple_checkboxes_independence(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        # Test that multiple checkboxes work independently
        check_box1 = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                               text="Check Box 1",
                               manager=default_ui_manager)
        check_box2 = UICheckBox(relative_rect=pygame.Rect(150, 100, 20, 20),
                               text="Check Box 2",
                               manager=default_ui_manager)
        
        # Toggle first checkbox
        check_box1.process_event(pygame.event.Event(pygame.MOUSEBUTTONDOWN,
                                                   {'button': pygame.BUTTON_LEFT,
                                                    'pos': check_box1.rect.center}))
        
        assert check_box1.get_state() is True
        assert check_box2.get_state() is False  # Should remain unchanged

    def test_keyboard_accessibility_space_key(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        # Press space key
        consumed = check_box.process_event(pygame.event.Event(pygame.KEYDOWN,
                                                             {'key': pygame.K_SPACE}))
        
        assert consumed is True
        assert check_box.get_state() is True

    def test_keyboard_accessibility_enter_key(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_keyboard_accessibility_unfocused_ignored(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_keyboard_accessibility_disabled_ignored(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_set_check_symbol(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_set_state_validation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        with pytest.raises(ValueError, match="State must be True, False, or 'indeterminate'"):
            check_box.set_state("true")
    ...
    def test_set_text_validation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_rebuild_method(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_load_theme_data_method(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_on_fresh_drawable_shape_ready(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_hover_state_management(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_disabled_hover_behavior(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_event_without_required_attributes(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        event_without_pos = pygame.event.Event(pygame.MOUSEBUTTONDOWN, {'button': pygame.BUTTON_LEFT})
    ...
    def test_text_label_integration(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_visibility_synchronization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_enable_disable_synchronization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_focus_set_includes_label(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_kill_cleanup(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_theme_shape_variations(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_theme_parameter_loading(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_drawable_shape_none_safety(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_initial_state_visual_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        """Test that initial state is visually consistent."""
        # Test unchecked initial state
        check_box_unchecked = UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                                        text="Unchecked",
                                        manager=default_ui_manager,
                                        initial_state=False)
        ...
        check_box_checked = UICheckBox(relative_rect=pygame.Rect(150, 100, 20, 20),
                                      text="Checked",
                                      manager=default_ui_manager,
                                      initial_state=True)
    ...
    def test_event_generation_data_integrity(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_specific_event_types(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_check_symbol_display_functionality(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_custom_check_symbol_display(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_font_loading_and_theming(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        default_symbol_font = default_ui_manager.ui_theme.get_font_dictionary().get_default_symbol_font()
        assert check_box.font == default_symbol_font

    def test_text_color_theming_parameters(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_drawable_shape_text_parameters(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_text_label_positioning_accuracy(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_text_label_position_updates(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_text_label_relative_position_updates(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_text_label_dimension_updates(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_text_offset_theming(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_state_visual_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        if hasattr(check_box.drawable_shape, 'active_state'):
            assert check_box.drawable_shape.active_state.state_id in ['normal', 'hovered']
    ...
    def test_hover_state_with_checked_box(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_disabled_state_visual_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        if hasattr(check_box.drawable_shape, 'active_state'):
            assert check_box.drawable_shape.active_state.state_id in ['normal', 'selected']

    def test_rebuild_preserves_state(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_theme_data_loading_completeness(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        required_attrs = [
            'colours', 'shape', 'border_width', 'shadow_width', 
            'border_overlap', 'shape_corner_radius', 'check_symbol', 
            'font', 'text_offset'
        ]
        ...
        required_colours = [
            'normal_bg', 'normal_border', 'hovered_bg', 'hovered_border',
            'disabled_bg', 'disabled_border', 'selected_bg', 'selected_border',
            'normal_text', 'hovered_text', 'disabled_text', 'selected_text'
        ]
        
        for colour in required_colours:
            assert colour in check_box.colours, f"Missing colour: {colour}"

    def test_container_positioning_integration(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_symbol_font_fallback(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        theme_font = default_ui_manager.ui_theme.get_font(check_box.combined_element_ids)
        default_font = default_ui_manager.ui_theme.get_font_dictionary().get_default_font()
    ...
    def test_multiple_state_changes_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        for state in states:
            ...
            if hasattr(check_box.drawable_shape, 'active_state'):
                ...
                assert check_box.drawable_shape.active_state.state_id == expected_visual_state

    def test_event_toggle_symbol_display(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_keyboard_toggle_symbol_display(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        check_box.process_event(pygame.event.Event(pygame.KEYDOWN,
                                                  {'key': pygame.K_SPACE}))
    ...
    def test_tooltip_functionality(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_state_basic(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_state_setting(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_toggle_behavior(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_symbol_customization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_visual_state(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_indeterminate_no_events(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        events = pygame.event.get()
        checkbox_events = [e for e in events if e.type in [pygame_gui.UI_CHECK_BOX_CHECKED, pygame_gui.UI_CHECK_BOX_UNCHECKED]]
        assert len(checkbox_events) == 0

    def test_state_validation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_with_kwargs(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_coordinate_positioning_with_tooltip(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        """Test coordinate positioning works with tooltip."""
        check_box = UICheckBox(relative_rect=(150, 200),
                              text="Test Check Box",
                              manager=default_ui_manager,
    ...
    def test_tooltip_cleanup_on_unhover(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_text_label_synchronization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        ...
        assert check_box.tool_tip_text_kwargs == check_box.text_label.tool_tip_text_kwargs
        assert check_box.tool_tip_object_id == check_box.text_label.tool_tip_object_id

    def test_tooltip_set_after_creation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_with_kwargs_synchronization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_update_synchronization(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_hover_behavior_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_with_disabled_checkbox(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_tooltip_removal(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_constructor_input_validation(self, _init_pygame, default_ui_manager, _display_surface_return_none):
        """Test that constructor validates input parameters."""
        # Test invalid text type
        with pytest.raises(ValueError, match="Checkbox text must be a string"):
            UICheckBox(relative_rect=pygame.Rect(100, 100, 20, 20),
                      text=123,
                      manager=default_ui_manager)
    ...
    def test_mouse_scaling_support(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_can_focus_method(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_update_method(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_focus_management_integration(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_comprehensive_state_consistency(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_error_handling_robustness(self, _init_pygame, default_ui_manager, _display_surface_return_none):
    ...
    def test_performance_multiple_operations(self, _init_pygame, default_ui_manager, _display_surface_return_none):
