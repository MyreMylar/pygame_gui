...
class TestUILabel:
    ...
    def test_rebuild_anchors(
        ...
        label = UILabel(
            relative_rect=pygame.Rect(100, 100, 150, -1),
            text="Test Label",
            manager=default_ui_manager,
    ...
    def test_rebuild_from_theme_data_non_default_1(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_label_non_default_1.json"),
        )
        label = UILabel(
            relative_rect=pygame.Rect(100, 100, 150, 30),
            text="Test Label",
    ...
    def test_rebuild_from_theme_data_non_default_2(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_label_non_default_2.json"),
        )
        label = UILabel(
            relative_rect=pygame.Rect(100, 100, 150, 30),
            text="Test Label",
    ...
    def test_rebuild_from_theme_data_non_default_3(
        self, _init_pygame, _display_surface_return_none
    ):
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_label_non_default_3.json"),
        )
        label = UILabel(
            relative_rect=pygame.Rect(100, 100, 150, 30),
            text="Test Label",
    ...
    def test_rebuild_from_theme_data_bad_values(
        ...
        manager = UIManager(
            (800, 600),
            os.path.join("tests", "data", "themes", "ui_label_bad_values.json"),
        )
        label = UILabel(
            relative_rect=pygame.Rect(100, 100, 10, 30),
            text="Test Label",
            manager=manager,
        )
        assert label.image is not None
    ...
    def test_change_locale(
        ...
        label = UILabel(
            pygame.Rect((10, 100), (150, 30)), "pygame-gui.English", default_ui_manager
        )
        ...
        label = UILabel(
            pygame.Rect((10, 100), (-1, 30)), "pygame-gui.English", default_ui_manager
        )
        default_ui_manager.set_locale("fr")
        ...
        label = UILabel(
            pygame.Rect((10, 100), (-1, -1)), "pygame-gui.English", default_ui_manager
        )
