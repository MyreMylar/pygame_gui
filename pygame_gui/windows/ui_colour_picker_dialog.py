...
class UIColourChannelEditor(UIElement):
    ...
    def __init__(
        ...
        self.element_container = UIContainer(
            self.relative_rect,
            self.ui_manager,
        ...
        self.label = UILabel(
            pygame.Rect(0, 0, -1, default_sizes["line_height"]),
            text=name,
    ...
    def _set_value_and_post_event(self, clipped_value):
        ...
        pygame.event.post(
            pygame.event.Event(UI_COLOUR_PICKER_COLOUR_CHANNEL_CHANGED, event_data)
        )
...
class UIColourPickerDialog(UIWindow):
    ...
    def __init__(
        ...
        *,
        ...
        current_colour_surface = pygame.surface.Surface(
        ...
        mini_colour_surf = pygame.surface.Surface(
            (2, 2), flags=pygame.SRCALPHA, depth=32
        )
        ...
        self.sat_value_square = UIImage(
            ...
            image_surface=pygame.transform.smoothscale(mini_colour_surf, (200, 200)),
            manager=self.ui_manager,
            container=self,
        )
        ...
        self.colour_2d_slider = UI2DSlider(
            self.sat_value_square.relative_rect,
            start_value_x=50,
            value_range_x=(0, 100),
            start_value_y=50,
            value_range_y=(0, 100),
    ...
    def _setup_channels(self, default_sizes):
        ...
        acc_channel_top += (
            default_sizes["channel_height"] + default_sizes["channel_spacing"]
        )
