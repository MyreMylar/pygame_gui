...
UI_HORIZONTAL_SLIDER_MOVED = 5
UI_SELECTION_LIST_NEW_SELECTION = 6
UI_SELECTION_LIST_DROPPED_SELECTION = 7
UI_SELECTION_LIST_DOUBLE_CLICKED_SELECTION = 8
UI_WINDOW_CLOSE = 9
UI_CONFIRMATION_DIALOG_CONFIRMED = 10
UI_FILE_DIALOG_PATH_PICKED = 11
UI_COLOUR_PICKER_COLOUR_PICKED = 12
UI_COLOUR_PICKER_COLOUR_CHANNEL_CHANGED = 13
