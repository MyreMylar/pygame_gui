...
from pygame_gui.core.components import Transform
...
class UIElement(GUISprite, IUIElementInterface):
    ...
    def __init__(self, relative_rect: Union[pygame.Rect, Tuple[int, int, int, int]],
        ...
        self.transform = Transform(self, relative_rect, anchors)
        ...
        self.transform.update_absolute_rect_position_from_anchors()
    ...
    def relative_rect(self):
        return self.transform.relative_rect

    @relative_rect.setter
    def relative_rect(self, relative_rect):
        self.transform.relative_rect = relative_rect

    @property
    def dynamic_width(self):
        return self.transform.dynamic_width

    @dynamic_width.setter
    def dynamic_width(self, dynamic_width):
        self.transform.dynamic_width = dynamic_width

    @property
    def dynamic_height(self):
        return self.transform.dynamic_height

    @dynamic_height.setter
    def dynamic_height(self, dynamic_height):
        self.transform.dynamic_height = dynamic_height

    @property
    def relative_right_margin(self):
        return self.transform.relative_right_margin

    @relative_right_margin.setter
    def relative_right_margin(self, relative_right_margin):
        self.transform.relative_right_margin = relative_right_margin

    @property
    def relative_bottom_margin(self):
        return self.transform.relative_bottom_margin

    @relative_bottom_margin.setter
    def relative_bottom_margin(self, relative_bottom_margin):
        self.transform.relative_bottom_margin = relative_bottom_margin
        
    @property
    def anchors(self):
        return self.transform.anchors

    @anchors.setter
    def anchors(self, anchors):
        self.transform.anchors = anchors

    def _on_contents_changed(self):
        if self.dynamic_width or self.dynamic_height:
            self.transform._calc_dynamic_size()
    ...
    def set_relative_position(self, position: Union[pygame.math.Vector2,
        ...
        """
        self.transform.on_set_relative_position(position)
    ...
    def set_position(self, position: Union[pygame.math.Vector2,
        ...
        """
        self.transform.on_set_position(position)
    ...
    def set_minimum_dimensions(self, dimensions: Union[pygame.math.Vector2,
        ...
        """
        self.transform.on_set_minimum_dimensions(dimensions)
    ...
    def set_dimensions(self, dimensions: Union[pygame.math.Vector2,
        ...
        """
        self.transform.on_set_dimensions(dimensions, clamp_to_container)
    ...
    # Prepare to remove this function. Convert to transform.get_anchor_targets()
    def get_anchor_targets(self) -> list:
        return self.transform.get_anchor_targets()
