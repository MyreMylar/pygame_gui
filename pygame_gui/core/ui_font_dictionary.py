...
class UIFontDictionary(IUIFontDictionaryInterface):
    ...
    def __init__(self, resource_loader: IResourceLoader, locale: str):
        ...
        self._latin_font = DefaultFontData(
            14,
            "noto_sans",
            "regular",
        ...
        self._symbols_font = DefaultFontData(
            14,
            "fira_code_symbols",
            "regular",
        ...
        self._japanese_font = DefaultFontData(
            14,
            "noto_sans_jp",
            "regular",
        ...
        self._chinese_font = DefaultFontData(
            14,
            "noto_sans_sc",
            "regular",
        ...
        self._korean_font = DefaultFontData(
            14,
            "noto_sans_kr",
            "regular",
        ...
        self._hebrew_font = DefaultFontData(
            14,
            "noto_sans_he",
            "regular",
        ...
        self._arabic_font = DefaultFontData(
            14,
            "noto_sans_ar",
            "regular",
        ...
        self._georgian_font = DefaultFontData(
            14,
            "noto_sans_ge",
            "regular",
        ...
        self.default_font_dictionary = {
            "ar": self._arabic_font,
            "de": self._latin_font,
            "en": self._latin_font,
            "es": self._latin_font,
            "fr": self._latin_font,
        ...
        self.known_font_paths: Dict[
            str, List[Tuple[Union[str, PackageResource, bytes], bool]]
        ] = {}
    ...
    def _load_default_font(self, font):
        ...
        default_font_res = FontResource(
            ...
            location=(
                PackageResource(
                    package="pygame_gui.data", resource=font.regular_file_name
                ),
                False,
            ),
        )
        ...
        self.known_font_paths[font.name] = [
            ...
            (
                PackageResource(
                    package="pygame_gui.data", resource=font.bold_file_name
                ),
                False,
            ),
            (
                PackageResource(
                    package="pygame_gui.data", resource=font.italic_file_name
                ),
                False,
            ),
            (
                PackageResource(
                    package="pygame_gui.data", resource=font.bold_italic_file_name
                ),
                False,
            ),
        ]
    ...
    def find_font_resource(
        ...
        if font_id not in self.used_font_ids:
            self.used_font_ids.append(
                font_id
            )  # record font usage for optimisation purposes
        ...
        if self.check_font_preloaded(font_id):  # font already loaded
            ...
            warning_string = (
                f"Finding font with id: {font_id}" + " that is not already loaded.\n"
    ...
    def _load_system_font(
        ...
        found_system_no_style_font_path = match_font(
            font_name, bold=False, italic=False
        )
        if bold or italic:
        ...
        if (
            found_system_no_style_font_path is not None
            and found_system_font_path is not None
        ):
            if bold and italic:
                self.add_font_path(
                    font_name,
                    font_path=found_system_no_style_font_path,
            ...
            self._load_single_font_style(
                (found_system_no_style_font_path, False),
                font_id,
                font_size,
                font_style={
                    "bold": True,
    ...
    def preload_font(
        ...
        if font_id in self.loaded_fonts:  # font already loaded
            warnings.warn(
                "Trying to pre-load font id: " + font_id + " that is already loaded",
                UserWarning,
            )
        elif font_name in self.known_font_paths:
        ...
        elif not self._load_system_font(
            font_id,
            font_size,
            font_name,
            bold,
    ...
    def _load_single_font_style(
        ...
        resource = FontResource(
            font_id=font_id, size=font_size, style=font_style, location=font_loc
        )
    ...
    def add_font_path(
        ...
        self.known_font_paths[font_name] = [
            ...
            (bold_italic_path, False)
            if bold_italic_path is not None
            else (regular_font_loc, False),
        ]
    ...
    def ensure_debug_font_loaded(self):
        ...
        if not self.check_font_preloaded(
            ...
            self.preload_font(
                self.debug_font_size, self.default_font.name, force_immediate_load=True
            )
