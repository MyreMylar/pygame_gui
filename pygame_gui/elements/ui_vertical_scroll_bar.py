...
class UIVerticalScrollBar(UIElement):
    ...
    def __init__(
        ...
        self.top_button: UIButton | None = None
        self.bottom_button: UIButton | None = None
        ...
        self._container_to_scroll: Optional[IContainerLikeInterface] = None
    ...
    def rebuild(self):
        ...
        """
        # Calculate total horizontal and vertical space taken by borders and shadows
        total_horiz_space = (
    ...
    def _check_is_focus_set_hovered(self) -> bool:
        ...
        """
        focus_set_hovered = False
        focus_set = self.get_focus_set()
        if focus_set is not None:
            focus_set_hovered = any(element.hovered for element in focus_set)
        return focus_set_hovered
